#
#  Be sure to run `pod spec lint ChheanUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ChheanUI"
  spec.version      = "0.0.1"
  spec.summary      = "This is library build for custom UI of ChheanUI."
  ...
  spec.author             = { "sour leangchhean" => "sourleangchhean@gmail.com" }
  # Or just: spec.author    = "SLC"
  # spec.authors            = { "SLC" => "slc@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/SLC"
